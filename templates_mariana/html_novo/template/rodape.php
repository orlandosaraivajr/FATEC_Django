...
<body>
    ...
    <footer data-spy="scroll" data-target="menu_navbar" data-offset="0" id="rodape">

        <p>FHO - Fundação Herminio Ometto
        <br>Desenvolvimento Web com framework Django 
        <br>Junio Horniche | Mariana Cardoso | Gabriel Furlan Rebessi | Pedro Pozzi Ferreira
        <br>Orientador: Prof. Me. Orlando Saraiva Júnior 
