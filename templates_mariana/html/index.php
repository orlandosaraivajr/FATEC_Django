        ...
        <div class="row">
            <div class="col-sm">
                ...
                <article class="clrbox">
                    <section>
                        <h5>Bem Vindo!</h5>
                        <p>O Sistema de Mapeamento de Sala de Aula foi idealizado pela equipe da Engenharia da Computação, com o objetivo realizar um levantamento contendo informações sobre os espaços físicos facilitando a alocação de aulas</p>
                    </section>
                </article>
