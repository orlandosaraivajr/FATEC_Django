      ...
      <div class="container">
            ...
            <form id="formExemplo" data-toggle="validator" role="form" method="post" action="#">
                ...
                <div class="form-group">
                    ...
                    <input name="cadUsuario" id="textNome" class="form-control" placeholder="Digite o seu nome..." required>
                </div>
                ...
                <div class="form-group">
                    <label for="inputAddress">*Endereço</label>
                        <input type="text" class="form-control" id="inputAddress" placeholder="Digite o seu endereço...">
                </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                      <label for="inputPassword" class="control-label"> *Senha </label>
                            <input name="cadSenha" id="inputPassword" class="form-control" placeholder="Digite a sua senha..." required>
                    </div>
                    
                    <div class="form-group col-md-6">
                      <label for="inputConfirmPassword" class="control-label"> * Confirme sua Senha </label>
                            <input name="cadSenha" id="inputConfirmPassword" class="form-control" placeholder="Confirme sua senha..." required>
                    </div>
